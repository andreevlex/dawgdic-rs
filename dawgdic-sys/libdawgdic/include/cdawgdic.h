...
void dawgdic_dictionary_shrink(const void *);
void dawgdic_dictionary_swap(void *, void *);
...
bool dawgdic_dictionary_contains2(const void *, const char *, const size_t);
int dawgdic_dictionary_find(const void *, const char *);
int dawgdic_dictionary_find2(const void *, const char *, const size_t);
bool dawgdic_dictionary_find3(const void *, const char *, int *);
bool dawgdic_dictionary_find4(const void *, const char *, const size_t, int *);
